...
//          var t_coor = to_where.coor;
           ...
           http.get('http://api2.juheapi.com/park/query?key=b0ed9eeca7218f83d29ec2b18d313ba5&lon=116.3654190000&lat=39.9700500000&distance=1000&limit=5', function(res) {
            //  var obj='\''+res+'\'';
            //   var obj = JSON.parse(res); 
            res.setEncoding('utf8'); 
            //res.setCharacterEncoding('utf8'); 
